...
def create_router(config: AppConfig) -> Router:
    ...
    async def accept(call: CallbackQuery) -> None:
        ...
        if success:
            ...
            # Текст про геолокацію (автоматично надіслана якщо є)
            if driver.last_lat and driver.last_lon:
                location_status = "📍 <b>Геолокація водія активна!</b> Ви бачите його на карті в реальному часі."
            else:
                location_status = "⚠️ <b>Геолокація водія тимчасово недоступна</b>"
