...
def clean_address(address: str) -> str:
    """
    Очистити адресу від Plus Codes, координат та зайвих символів.
    ...
    # Видалити старий формат координат: 📍 50.450100, 30.523400
    address = re.sub(r'📍\s*[\d\.,\s]+', '', address)
    
    # Видалити новий формат: Точка на карті (50.4501, 30.5234)
    address = re.sub(r'Точка на карті\s*\([^)]+\)', '', address)
    
    # Видалити просто координати в дужках: (50.4501, 30.5234)
